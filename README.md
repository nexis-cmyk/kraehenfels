...
Die öffentliche Release-Version 2.0.3 ist hier verfügbar:

- [GitHub-Repository](https://github.com/nexis-cmyk/kraehenfels)
- [Kraehenfels.ipa herunterladen](https://github.com/nexis-cmyk/kraehenfels/releases/download/v2.0.3/Kraehenfels.ipa)
