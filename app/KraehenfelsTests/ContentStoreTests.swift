...
final class ContentStoreTests: XCTestCase {
    ...
    func testV6AudioPlanDecodesWithLayerInstructions() throws {
        let payload = #"""
        {
          "meta": {"title":"Test","appTitle":"Test","subtitle":"SL","system":"HTBAH","setting":"1890","language":"de","version":"3.3.0-rc1","minimumIOS":"17.0"},
        ...
        XCTAssertEqual(manifest.meta.version, "3.3.0-rc1")
