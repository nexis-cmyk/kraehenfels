...
enum GuidedFlowCatalog {
    ...
    private static let innSteps: [GuideStep] = [
        ...
        GuideStep(id: "S02_CLUE", sceneID: "S02", kind: .clue, title: "Gästebuch und Riegel", body: "Zeige H03, sobald jemand nach früheren Gästen, roten Strichen oder der verschlossenen Tür fragt. H02 ist ein optionaler Zeitungsbeleg und darf zusätzlich gezeigt werden. C03 und C04 sind garantiert. Bei einem passenden Gespräch nennt Elara den letzten gestrichenen Namen.", actionLabel: "H03 zeigen", clueID: "C03", handoutID: "H03", handoutIDs: ["H02"], audioCueID: "SFX03"),
    ...
    private static let churchSteps: [GuideStep] = [
        ...
        GuideStep(id: "S03_CLUE", sceneID: "S03", kind: .clue, title: "Das alte Gastrecht", body: "Zeige H04 oder lies die Ersatzzeile vor: Wer unter einem Krähenfelser Dach schläft, steht bis zum Hahnenschrei unter Schutz. Spiele SFX10 erst, nachdem Falk das Wort Gastrecht ausgesprochen hat. Dieser Hinweis ist nicht von einer Probe abhängig.", actionLabel: "H04 zeigen", clueID: "C05", handoutID: "H04", npcID: "N04", audioCueID: "SFX10"),
    ...
    private static let woodsSteps: [GuideStep] = [
        ...
        GuideStep(id: "S05_CLUE", sceneID: "S05", kind: .clue, title: "Zeichnung, Rubbing und Forstkarte", body: "Zeige H07, H08 und H10 in dieser Reihenfolge. Sie führen zur Eiche und erklären die drei Handlungsmöglichkeiten. Spiele SFX06 nur bei dem Moment, in dem die Spur scheinbar hinter der Gruppe weitergeht. Die Spur selbst ist sicher; ein Würfelwurf bestimmt nur Zeit und Kälte.", actionLabel: "Drei Hinweise zeigen", clueID: "C08", handoutID: "H07", handoutIDs: ["H08", "H10"], npcID: "N06", audioCueID: "SFX06"),
        ...
        GuideStep(id: "S05_NEXT", sceneID: "S05", kind: .next, title: "Zur nächsten Ermittlungsstation", body: "Markiere die Waldspur als besucht. Wenn noch Tatsachen fehlen, führt der nächste sinnvolle Schritt ins Archiv – die App schaltet es nach zwei Ermittlungsorten frei. Die Eiche bleibt bis zur Wahrheitsphase ein Ziel, kein Finale.", actionLabel: "Ort wählen", options: [GuideOption(id: "archive", title: "Rathausarchiv", detail: "Die Winterbuchhaltung prüfen.", destinationSceneID: "S06"), GuideOption(id: "church", title: "Kirche", detail: "Das Gastrecht ergänzen.", destinationSceneID: "S03"), GuideOption(id: "smithy", title: "Schmiede", detail: "Das Eisen sichern.", destinationSceneID: "S04")])
    ]
