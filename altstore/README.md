...
Der fertige Feed liegt als [`source.json`](source.json) im Repository. Die aktuelle IPA ist Version 2.0.1; die Datei enthält Download-URL, Größe und SHA-256-Prüfsumme.
